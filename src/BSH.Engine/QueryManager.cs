...
namespace Brightbits.BSH.Engine
{
    public class QueryManager
    {
        ...
        public QueryManager(DbClientFactory dbClientFactory,
            ConfigurationManager configurationManager)
        {
            this.dbClientFactory = dbClientFactory;
            this.configurationManager = configurationManager;
            this.storageFactory = new StorageFactory(configurationManager);
        }

        public ConfigurationManager Configuration { get => configurationManager; }

        public string DatabaseFile { get => dbClientFactory.DatabaseFile; }
