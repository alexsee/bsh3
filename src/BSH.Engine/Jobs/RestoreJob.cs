...
namespace Brightbits.BSH.Engine.Jobs
{
    ...
    public class RestoreJob : Job
    {
        ...
        public FileOverwrite FileOverwrite { get; set; }
        ...
        public RestoreJob(IStorage storage,
            ...
            QueryManager queryManager) : base(storage, dbClientFactory, queryManager)
        {
        ...
        public async Task RestoreAsync(CancellationToken token)
        {
            ...
            using (var dbClient = dbClientFactory.CreateDbClient())
            {
                ...
                if (string.IsNullOrEmpty(Destination))
                {
                    ...
                    {
                        sources = queryManager.Configuration.SourceFolder;
                    }
