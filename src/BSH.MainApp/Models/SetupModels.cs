...
public sealed class NewSetupConfiguration
{
    ...
    public required SetupTargetKind TargetKind { get; init; }

    public string? LocalBackupFolder { get; init; }

    public string? MediaVolumeSerial { get; init; }
    ...
    public string? FtpFolder { get; init; }

    public string? FtpEncoding { get; init; }

    public bool FtpEnforceUnencrypted { get; init; }
